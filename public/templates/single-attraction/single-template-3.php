...
<article
	...
	<div class="trvlr-sa3__inner">
		<div class="trvlr-sa3__main">
			<section class="trvlr-sa3__hero">
				...
				<div class="trvlr-sa3__hero-inner">
					...
					<h1 class="trvlr-sa3__title"><?php echo esc_html(get_trvlr_title($post_id)); ?></h1>
				</div>
				<div class="trvlr-sa3__summary-container">
					<div class="trvlr-sa3__summary">
						<?php if ($price_value) : ?>
							<div class="trvlr-sa3__summary-item trvlr-sa3__summary-item--price">
			...
			<div class="trvlr-sa3__content">
				<div class="trvlr-sa3__content-container">
					<?php if ($has_gallery) : ?>
						<section class="trvlr-sa3__gallery">
							<?php echo $gallery_out; ?>
						</section>
					<?php endif; ?>
					<section class="trvlr-sa3__intro">
						<?php echo trvlr_short_description($post_id); ?>
					</section>
					<?php if ($highlights_out !== '') : ?>
						<section class="trvlr-sa3__section">
		...
		<aside class="trvlr-sa3__sidebar" aria-label="<?php esc_attr_e('Booking', 'trvlr'); ?>">
			<div class="trvlr-sa3__sidebar-inner">
	...
	<button
		type="button"
		class="trvlr-sa3__mobile-availability trvlr-check-availability"
