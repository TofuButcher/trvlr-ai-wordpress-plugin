...
<article
	...
	<div class="flex flex-col items-center px-gutter">
	<div class="trvlr-container">
		...
		<div class="trvlr-single-attraction__columns trvlr-sidebar-layout">
			<div class="trvlr-single-attraction__main trvlr-main-content">
				<div class="trvlr-container">
				<div class="trvlr-single-attraction__meta">
					...
					<?php echo trvlr_booking_button($post_id); ?>
				</div>
				<?php echo trvlr_gallery($post_id, array(
					'type' => 'slider',
					'layout' => 'nav-right',
				)); ?>
			...
			<div class="trvlr-single-attraction__sidebar trvlr-sidebar">
