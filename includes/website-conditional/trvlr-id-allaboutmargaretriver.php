...
add_action('wp_enqueue_scripts', 'trvlr_website_conditional_allaboutmargaretriver_styles', 20);

function trvlr_website_conditional_allaboutmargaretriver_styles()
{
  $css = <<<'CSS'
  @layer trvlr.custom {
  :root {
