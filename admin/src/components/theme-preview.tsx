...
export const AttractionCardPreview = () => {
   return (
      <div className="attraction-card" style={{ width: '100%' }}>
         <div className="attraction-card__image-wrap">
            <img
               width="300"
               height="225"
               src="https://picsum.photos/id/866/300/225"
               className="attraction-card__image wp-post-image"
               alt="Preview attraction"
            />
            <div className="attraction-card__popular-badge">
         ...
         <div className="attraction-card__content">
            ...
            <div className="attraction-card__text-wrap">
               <div className="attraction-card__text-item">
                  <svg viewBox="0 0 18 18">
                  ...
                  <span>5 hours 15 mins</span>
               </div>
            </div>
            <div className="attraction-card__footer">
               <div className="attraction-card__price">
                  <span className="attraction-card__price-value">
                     from $215						</span>
                  <span className="attraction-card__price-type">
                     per person							</span>
               </div>
               <button className="attraction-card__book-now trvlr-book-now" attraction-id="5220">
                  <span>Book Now</span>
