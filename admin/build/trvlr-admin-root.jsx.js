...
const TrvlrProvider = ({
  ...
  const value = {
    ...
    templateChoices: initialData.templateChoices || {
      cards: [],
      singles: [],
      presentationThemes: []
    },
...
const ConnectionSettingsForm = () => {
  ...
  const [disablePostType, setDisablePostType] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(!!connectionSettings.disable_attraction_post_type);
  const [disableSync, setDisableSync] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(!!connectionSettings.disable_attraction_sync);
  const [disableFrontendBooking, setDisableFrontendBooking] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(!!connectionSettings.disable_frontend_booking);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
    ...
    children: [saveStatus === 'success' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Notice, {
      ...
      className: "trvlr-connection-features",
      style: {
        marginTop: '1.5rem'
      },
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("h3", {
        className: "trvlr-settings-heading",
        style: {
          marginBottom: '0.25rem'
        },
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('TRVLR features', 'trvlr')
        ...
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Turn off what you don’t need', 'trvlr')
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Disable TRVLR Attraction post type', 'trvlr'),
        help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('When enabled, the plugin does not register the trvlr_attraction post type. Use your own post types or content; syncing from TRVLR is turned off while this is enabled.', 'trvlr'),
        checked: disablePostType,
        onChange: onDisablePostTypeChange
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Disable syncing attractions from TRVLR', 'trvlr'),
        help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('When enabled, scheduled and manual catalog sync do not run. Per-attraction sync controls are unavailable.', 'trvlr'),
        checked: syncToggleChecked,
        disabled: syncToggleDisabled,
        onChange: v => !syncToggleDisabled && setDisableSync(v)
      }), syncToggleDisabled && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("p", {
        style: {
          margin: '-8px 0 12px',
          paddingLeft: '48px',
          fontSize: '12px',
        ...
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Unavailable while the TRVLR Attraction post type is disabled.', 'trvlr')
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Disable frontend booking (scripts & modals)', 'trvlr'),
        help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Stops loading the booking modal, checkout embed, and related scripts. You can still use shortcodes and templates for display if you build a custom booking flow.', 'trvlr'),
...
const CustomEditsForm = () => {
  ...
  const loadCustomEdits = async () => {
    try {
      const raw = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
  ...
  const handleMarkAllForForceSync = async () => {
    if (!confirm((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Mark every edited field on every listed attraction to be overwritten from the API on the next sync? This replaces your current force sync selections.', 'trvlr'))) {
      return;
    }
    const all = {};
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
    ...
    children: [message && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Notice, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        ...
        isBusy: saving,
        disabled: saving,
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Mark All Fields for Force Sync', 'trvlr')
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        variant: "secondary",
        onClick: handleClear,
        disabled: saving,
...
const ThemeSettings = () => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    setSettings((0,_context_TrvlrContext__WEBPACK_IMPORTED_MODULE_3__.mergeWithDefaults)(themeSettings, themeConfig));
  ...
  const resetToDefaults = () => {
    if (confirm((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Reset all theme settings to defaults?', 'trvlr'))) {
      setSettings(prev => {
        const p = prev;
        return {
          ...(0,_context_TrvlrContext__WEBPACK_IMPORTED_MODULE_3__.getThemeDefaults)(themeConfig),
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components_page_heading__WEBPACK_IMPORTED_MODULE_4__.PageHeading, {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Panel, {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
            title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Presentation theme', 'trvlr'),
            initialOpen: true,
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.RadioControl, {
              label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Theme (card, attraction page, and styles)', 'trvlr'),
              selected: String((_presentationTheme = settings.presentationTheme) !== null && _presentationTheme !== void 0 ? _presentationTheme : ''),
              options: (templateChoices.presentationThemes || []).map(c => ({
                label: c.label,
                value: c.slug
              })),
